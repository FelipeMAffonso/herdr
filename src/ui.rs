...
pub(crate) use self::{
    ...
    sidebar::{
        agent_display_row_gap, agent_display_row_height, agent_entry_gap,
        agent_entry_height_in_body, agent_panel_body_rect, agent_panel_display_row_for_entry,
        agent_panel_display_rows, agent_panel_entries, agent_panel_scroll_for_target,
        agent_panel_scroll_metrics, agent_panel_scrollbar_rect, agent_panel_toggle_rect,
        agent_tag_collapse_key, all_agent_panel_entries, collapsed_sidebar_sections,
        collapsed_sidebar_toggle_rect, compute_workspace_card_areas, expanded_sidebar_sections,
        expanded_sidebar_toggle_rect, normalized_workspace_scroll, sidebar_section_divider_rect,
        tag_collapse_key, workspace_display_order, workspace_display_row_index,
        workspace_drop_slots, workspace_group_chevron_rect, workspace_list_entries_expanded,
